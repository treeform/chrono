...
suite "timestamps":
  ...
  test "time zones random":
    ...
    testTime(7037013, "1970-03-23T22:43:33+12:00", "Pacific/Funafuti")
    ...
    testTime(16419697, "1970-07-10T10:01:37+09:00", "Pacific/Palau")
    ...
    testTime(65678788, "1972-01-31T14:06:28+10:00", "Pacific/Chuuk")
    ...
    testTime(140740260, "1974-06-18T05:01:00+06:30", "Indian/Cocos")
    ...
    testTime(197036364, "1976-03-30T12:19:24Z", "Antarctica/Troll")
    testTime(199382035, "1976-04-26T03:53:55-12:00", "Pacific/Enderbury")
    ...
    testTime(248641126, "1977-11-17T18:58:46Z", "Africa/Conakry")
    testTime(250986797, "1977-12-14T23:33:17+01:00", "Africa/Ndjamena")
    testTime(253332468, "1978-01-11T02:07:48Z", "Africa/Sao_Tome")
    ...
    testTime(260369481, "1978-04-02T02:21:21-10:30", "Pacific/Rarotonga")
    testTime(262715152, "1978-04-29T09:25:52-07:00", "America/Yellowknife")
    testTime(265060823, "1978-05-26T20:00:23Z", "Atlantic/Reykjavik")
    ...
    testTime(276789178, "1978-10-09T13:52:58Z", "Europe/Lisbon")
    ...
    testTime(286171862, "1979-01-26T04:11:02Z", "Africa/Freetown")
    ...
    testTime(297900217, "1979-06-11T08:03:37+10:00", "Australia/Lord_Howe")
    testTime(300245888, "1979-07-07T18:38:08-07:00", "America/Tijuana")
    testTime(302591559, "1979-08-04T05:12:39Z", "Atlantic/St_Helena")
    ...
    testTime(330739611, "1980-06-25T00:06:51Z", "Africa/El_Aaiun")
    ...
    testTime(349504979, "1981-01-28T13:42:59+09:00", "Pacific/Palau")
    ...
    testTime(356541992, "1981-04-20T03:26:32+12:00", "Pacific/Funafuti")
    testTime(358887663, "1981-05-17T01:01:03+06:00", "Asia/Ashgabat")
    testTime(361233334, "1981-06-13T02:35:34+04:00", "Europe/Chisinau")
    testTime(363579005, "1981-07-10T02:10:05Z", "Africa/Nouakchott")
    ...
    testTime(382344373, "1982-02-12T13:16:13+06:30", "Indian/Cocos")
    ...
    testTime(473825542, "1985-01-06T02:12:22Z", "Europe/Jersey")
    ...
    testTime(534812988, "1986-12-12T23:09:48Z", "Africa/Monrovia")
    testTime(537158659, "1987-01-09T02:44:19Z", "Atlantic/Faroe")
    ...
    testTime(574689395, "1988-03-18T22:56:35+11:00", "Pacific/Pohnpei")
    ...
    testTime(607528789, "1989-04-02T02:59:49-11:00", "Pacific/Fakaofo")
    ...
    testTime(619257144, "1989-08-16T16:52:24+09:00", "Pacific/Palau")
    ...
    testTime(675553248, "1991-05-29T21:40:48Z", "Africa/Monrovia")
    ...
    testTime(691972945, "1991-12-05T20:42:25-02:00", "Atlantic/South_Georgia")
    ...
    testTime(710738313, "1992-07-10T03:18:33Z", "Africa/Abidjan")
    ...
    testTime(743577707, "1993-07-25T05:21:47Z", "Atlantic/Reykjavik")
    testTime(745923378, "1993-08-21T02:56:18-06:00", "America/Boise")
    testTime(748269049, "1993-09-17T12:30:49Z", "Atlantic/Reykjavik")
    ...
    testTime(757651733, "1994-01-04T02:48:53Z", "Europe/Guernsey")
    ...
    testTime(802219482, "1995-06-03T22:44:42Z", "Africa/Accra")
    ...
    testTime(828021863, "1996-03-28T23:04:23+09:00", "Pacific/Palau")
    ...
    testTime(849132902, "1996-11-27T22:15:02Z", "Africa/Casablanca")
    ...
    testTime(863206928, "1997-05-10T06:42:08+11:00", "Pacific/Pohnpei")
    testTime(865552599, "1997-06-05T18:16:39-05:00", "America/Eirunepe")
    testTime(867898270, "1997-07-03T02:51:10Z", "Africa/Bamako")
    ...
    testTime(881972296, "1997-12-12T14:18:16-10:00", "Pacific/Rarotonga")
    ...
    testTime(905429006, "1998-09-10T22:03:26+10:00", "Pacific/Port_Moresby")
    ...
    testTime(924194374, "1999-04-15T16:39:34Z", "Africa/Sao_Tome")
    testTime(926540045, "1999-05-12T13:14:05-07:00", "America/Hermosillo")
    testTime(928885716, "1999-06-08T23:48:36Z", "Atlantic/St_Helena")
    ...
    testTime(978144807, "2000-12-30T14:53:27+12:00", "Pacific/Wake")
    ...
    testTime(1013329872, "2002-02-10T19:31:12+11:00", "Australia/Lord_Howe")
    ...
    testTime(1034440911, "2002-10-12T16:41:51Z", "Africa/Bamako")
    testTime(1036786582, "2002-11-08T20:16:22Z", "Africa/Accra")
    ...
    testTime(1043823595, "2003-01-29T16:59:55+10:00", "Pacific/Chuuk")
    ...
    testTime(1069625976, "2003-11-24T04:49:36+06:30", "Indian/Cocos")
    ...
    testTime(1095428357, "2004-09-17T13:39:17Z", "Africa/El_Aaiun")
    ...
    testTime(1147033119, "2006-05-07T20:18:39Z", "Atlantic/St_Helena")
    testTime(1149378790, "2006-06-04T00:53:10+01:00", "Atlantic/Canary")
    testTime(1151724461, "2006-07-01T03:27:41Z", "America/Scoresbysund")
    testTime(1154070132, "2006-07-28T19:02:12+12:00", "Pacific/Wake")
    ...
    testTime(1163452816, "2006-11-14T08:20:16+11:00", "Pacific/Pohnpei")
    ...
    testTime(1193946539, "2007-11-01T19:48:59Z", "Africa/El_Aaiun")
    ...
    testTime(1252588314, "2009-09-11T01:11:54+12:00", "Pacific/Funafuti")
    ...
    testTime(1269008011, "2010-03-20T00:13:31+10:00", "Pacific/Port_Moresby")
    ...
    testTime(1306538747, "2011-05-27T23:25:47Z", "Africa/Bamako")
    ...
    testTime(1468390046, "2016-07-13T06:07:26Z", "Africa/Nouakchott")
    ...
    testTime(1480118401, "2016-11-26T00:00:01Z", "Africa/Ouagadougou")
    ...
    testTime(1522340479, "2018-03-30T02:21:19+10:00", "Pacific/Chuuk")
    ...
    testTime(1548142860, "2019-01-22T07:41:00Z", "Africa/Monrovia")
    testTime(1550488531, "2019-02-18T12:15:31+01:00", "Africa/Tunis")
    testTime(1552834202, "2019-03-17T14:50:02Z", "Africa/Bamako")
    ...
    testTime(1566908228, "2019-08-27T22:17:08+10:00", "Pacific/Port_Moresby")
    ...
    testTime(1578636583, "2020-01-10T06:09:43Z", "Africa/Banjul")
    ...
    testTime(1590364938, "2020-05-25T00:02:18Z", "Africa/Bissau")
    testTime(1592710609, "2020-06-21T10:06:49+06:30", "Indian/Cocos")
    testTime(1595056280, "2020-07-18T01:11:20-06:00", "America/El_Salvador")
    testTime(1597401951, "2020-08-14T23:45:51+13:00", "Pacific/Enderbury")
    ...
    testTime(1604438964, "2020-11-03T21:29:24Z", "Africa/Casablanca")
    testTime(1606784635, "2020-12-01T01:03:55Z", "Africa/Bissau")
