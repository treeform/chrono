...
/* Command for C compiler:
   clang -c  -w  -I/p/Nim/lib -o /p/calendars/test/nimcache/stdlib_macros.o /p/calendars/test/nimcache/stdlib_macros.c */
...
typedef struct LineInfo_iaJhdGB5Q2GppYhH0fz7tg LineInfo_iaJhdGB5Q2GppYhH0fz7tg;
...
struct LineInfo_iaJhdGB5Q2GppYhH0fz7tg {
...
N_NIMCALL(NimStringDesc*, dollar__Yy6vNPknrxyp1xFe9a5mM3g)(LineInfo_iaJhdGB5Q2GppYhH0fz7tg* arg);
...
{	result = (NI)0;
	nimln_(1064, "macros.nim");
	i = ((NI) 0);
	nimln_(1065, "macros.nim");
	j = ((NI) 0);
