...
suite "calendars":
  ...
  test "parseIsoCalendar":
    check parseIsoCalendar("1970-01-01T00:00:00Z") == Calendar(year: 1970, month: 1, day: 1)
    ...
    check parseIsoCalendar("1970-01-01T01:02:03Z") == Calendar(year: 1970, month: 1, day: 1, hour: 1, minute: 2, second: 3)
    check parseIsoCalendar("9999-12-31T59:59:59Z") == Calendar(year: 9999, month: 12, day: 31, hour: 59, minute: 59, second: 59)
  ...
  test "formatIso":
    ...
    check formatIso(Calendar(year: 1970, month: 1, day: 1, hour: 1, minute: 2, second: 3)) == "1970-01-01T01:02:03Z"
    check formatIso(Calendar(year: 9999, month: 12, day: 31, hour: 59, minute: 59, second: 59)) == "9999-12-31T59:59:59Z"
  ...
  test "formatCalendar":
    ...
    proc testFormat(iso, format, value: string) =
      var formatted = parseIsoCalendar(iso).formatCalendar(format)
      if formatted != value:
        echo "format: ", format
        echo "cal:    ", iso
        echo "---"
